...
vim.keymap.set({ "n", "v" }, "*", function()
  if vim.v.count > 0 then
    ...
    -- TODO: Not needed anymore after the n, N bindings below
...
vim.keymap.set("x", "n", function() search_jump_with_offset("n") end, { desc = "Next Search Result", remap = false })
vim.keymap.set("x", "N", function() search_jump_with_offset("N") end, { desc = "Prev Search Result", remap = false })
vim.keymap.set("o", "n", function() search_jump_with_offset("n") end, { desc = "Next Search Result", remap = false })
vim.keymap.set("o", "N", function() search_jump_with_offset("N") end, { desc = "Prev Search Result", remap = false })
